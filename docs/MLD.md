...
erDiagram
    ...
    %% RELATIONS PRINCIPALES
    User ||--o{ Candidature : "dépose"
    User ||--o{ Film : "réalise"
    User ||--o{ Comment : "écrit"
    User ||--o{ Note : "donne"
    User ||--o{ Notification : "reçoit"
    
    Candidature ||--|| Film : "génère"
    
    Film ||--o{ Comment : "reçoit"
    Film ||--o{ Note : "évalué par"
    Film ||--o{ Selection : "sélectionné"
    Film ||--o{ Laureat : "récompensé"
    
    %% RELATIONS N:N VIA TABLES D'ASSOCIATION
    User ||--o{ User_Role : "a rôle"
    Role ||--o{ User_Role : "assigné à"
    
    User ||--o{ Workshop_User : "participe"
    Workshop ||--o{ Workshop_User : "accueille"
    
    User ||--o{ Newsletter_User : "abonné"
    Newsletter ||--o{ Newsletter_User : "diffusé à"
    
    Film ||--o{ Playlist_Film : "dans"
    Playlist ||--o{ Playlist_Film : "contient"
    
    Film ||--o{ Film_AItool : "utilise"
    AI_tools ||--o{ Film_AItool : "utilisé par"
    
    Workshop ||--o{ Agenda_Workshop : "programmé"
    Agenda ||--o{ Agenda_Workshop : "planifie"
```
